    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
       ...
       <div style="width:380px; float:left;"></div>
        <img 
        src="resources/customerProfile/test.PNG" alt="" class="img-fluid rounded-circle" 
  	...
  	<nav class="nav-menu d-none d-lg-block" data-aos="fade-in">
        ...
        <ul style="list-style : none;">
          	<li class="active"><a href="#modalInfo" data-toggle="modal"><i class="bx bx-user"></i><span>INFO MODIFY</span></a></li>
          	...
          	<li><a href="#contact"><i class="bx bx-envelope"></i> Chatting</a></li>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
            <div class="about-img">
              <img src="resources/customerProfile/test.PNG" alt="">
            </div>
          </div>
			...
			<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document" >
				...
				<div class="modal-content" style="background-color: rgba(255, 255, 255, 0.4);">
					...
					<div class="modal-body book-a-table">
						<form action="modifyCustomer.na" 
						method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100" enctype="multipart/form-data">
				          <div>
				         	<!-- 이름 -->
				            <div class="col-lg-4 col-md-6 form-group">
				              Customer Name : 
				              <input type="text" value="${ loginCustomer.customerName }" name="customerName" class="form-control" id="name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" readonly>
				            ...
				            <div class="col-lg-4 col-md-6 form-group">
				             ...
				             <input type="password" name="password" class="form-control" id="confirmPassowrd" placeholder="Confirm Password" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
				              <div class="validate"></div>
				            </div>
				            <!-- 프로필사진 업로드-->
				            <div class="col-lg-4 col-md-6 form-group">
				            ...
				            <!-- 근무지주소 -->
				            <div class="col-lg-4 col-md-6 form-group">
				              <input type="text" name="post" class="form-control postcodify_postcode5 address" id="address" placeholder="Your WorkAddress" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
				              <input type="text" name="address1" class="postcodify_address address">
				              <input type="text" name="address2" class="postcodify_extra_info address">
				              <div class="validate"></div>
				            </div>
				            ...
				            <div class="col-lg-4 col-md-6 form-group">
				               Phone
				               <input type="text" name="phone" value="${ loginCustomer.phone }"class="form-control" id="name" placeholder="Your Phone" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
				            </div>			            			            				            				            
				          </div>
				          <div class="mb-3">
				            <div class="loading">Loading</div>
